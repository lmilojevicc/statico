...
class TestConversion(unittest.TestCase):
    def test_bold_text_to_html_node(self):
        bold_txt_node = TextNode("cool", TextType.BOLD_TEXT, None)
    ...
    def test_anchor_text_to_html_node(self):
        link_txt_node = TextNode("cool", TextType.LINK_TEXT, "https://example.com")
    ...
    def test_image_to_html_node(self):
        img_txt_node = TextNode(
            "cool", TextType.EMBEDED_IMAGE_TEXT, "https://example.com"
        )
